  ...
  return (
    <Box sx={styles.root}>
      ...
      <Box sx={styles.compassCardinals}>
        <Box>
          <RemoveTwoTone />
          <Text variant="caption">{t('compass.north')}</Text>
        </Box>
        <Box>
          <RemoveTwoTone />
          <Text variant="caption">{t('compass.east')}</Text>
        </Box>
        <Box>
          <RemoveTwoTone />
          <Text variant="caption">{t('compass.south')}</Text>
        </Box>
        <Box>
          <RemoveTwoTone />
          <Text variant="caption">{t('compass.west')}</Text>
        </Box>
      </Box>
